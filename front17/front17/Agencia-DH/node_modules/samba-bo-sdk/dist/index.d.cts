...
/**
 * empty samba_bo client
 */
interface SambaBOClient<Schema> {
    url: URL;
    globals: ClientGlobals;
    with: <Extension extends object>(createExtension: (client: SambaBOClient<Schema>) => Extension) => this & Extension;
}
/**
...
/**
 * Creates a client to authenticate with SambaBO.
 *
 * @param mode AuthenticationMode
 * @param config The optional configuration.
 *
 * @returns A SambaBO authentication client.
 */
declare const authentication: (mode?: AuthenticationMode, config?: Partial<AuthenticationConfig>) => <Schema>(client: SambaBOClient<Schema>) => AuthenticationClient<Schema>;

/**
 * Creates a client to authenticate with SambaBO using a static token.
 *
 * @param token static token.
 *
 * @returns A SambaBO static token client.
 */
declare const staticToken: (access_token: string) => <Schema>(_client: SambaBOClient<Schema>) => StaticTokenClient<Schema>;
...
/**
 * Creates a client to communicate with a SambaBO app.
 *
 * @param url The URL to the SambaBO app.
 * @param config The optional configuration.
 *
 * @returns A SambaBO client.
 */
declare const createSambaBO: <Schema = any>(url: string, options?: ClientOptions) => SambaBOClient<Schema>;
...
/**
 * Creates a client to communicate with SambaBO GraphQL.
 *
 * @returns A SambaBO GraphQL client.
 */
declare const graphql: (config?: Partial<GraphqlConfig>) => <Schema>(client: SambaBOClient<Schema>) => GraphqlClient<Schema>;
...
type SambaBOCollection<Schema = any> = {
    collection: string;
    meta: MergeCoreCollection<Schema, 'samba_bo_collections', {
        collection: string;
        icon: string | null;
        note: string | null;
    ...
    fields?: NestedPartial<SambaBOField<Schema>>[];
};
...
type SambaBOPermission<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_permissions', {
    id: number;
    role: SambaBORole<Schema> | string | null;
    collection: string;
    action: string;
...
type SambaBOPolicy<Schema> = MergeCoreCollection<Schema, 'samba_bo_policies', {
    id: string;
    icon: string;
    ...
    app_access: boolean;
    permissions: number[] | SambaBOPermission<Schema>[];
    users: string[] | SambaBOUser<Schema>[];
    roles: string[] | SambaBORole<Schema>[];
}>;

type SambaBORole<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_roles', {
    id: string;
    name: string;
    icon: string;
    description: string | null;
    parent: string | SambaBORole<Schema>;
    children: string[] | SambaBORole<Schema>[];
    policies: string[] | SambaBOPolicy<Schema>[];
    users: string[] | SambaBOUser<Schema>[];
}>;

type SambaBOFolder<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_folders', {
    id: string;
    name: string;
    parent: SambaBOFolder<Schema> | string | null;
}>;

type SambaBOFile<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_files', {
    id: string;
    storage: string;
    ...
    title: string | null;
    type: string | null;
    folder: SambaBOFolder<Schema> | string | null;
    uploaded_by: SambaBOUser<Schema> | string | null;
    uploaded_on: 'datetime';
    modified_by: SambaBOUser<Schema> | string | null;
 ...
 * samba_bo_users type
 */
type SambaBOUser<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_users', {
    id: string;
    ...
    description: string | null;
    tags: string[] | null;
    avatar: SambaBOFile<Schema> | string | null;
...
type SambaBOVersion<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_versions', {
    id: string;
    key: string;
    name: string | null;
    collection: SambaBOCollection<Schema> | string;
    item: string;
    hash: string;
    date_created: 'datetime' | null;
    date_updated: 'datetime' | null;
    user_created: SambaBOUser<Schema> | string | null;
    user_updated: SambaBOUser<Schema> | string | null;
}>;

type SambaBORevision<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_revisions', {
    id: number;
    activity: SambaBOActivity<Schema> | number;
    collection: string;
    item: string;
    data: Record<string, any> | null;
    delta: Record<string, any> | null;
    parent: SambaBORevision<Schema> | number | null;
    version: SambaBOVersion<Schema> | string | null;
}>;

type SambaBOActivity<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_activity', {
    id: number;
    action: string;
    user: SambaBOUser<Schema> | string | null;
    timestamp: 'datetime';
    ip: string | null;
    ...
    comment: string | null;
    origin: string | null;
    revisions: SambaBORevision<Schema>[] | number[] | null;
}>;

type SambaBODashboard<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_dashboards', {
    id: string;
    name: string;
    icon: string;
    note: string | null;
...
type SambaBOExtension<Schema = any> = {
    name: string;
    bundle: string | null;
    schema: ExtensionSchema | null;
    meta: MergeCoreCollection<Schema, 'samba_bo_extensions', {
        enabled: boolean;
    }>;
};
...
type SambaBOField<Schema = any> = {
    collection: string;
    field: string;
    type: string;
    meta: MergeCoreCollection<Schema, 'samba_bo_fields', {
        id: number;
        collection: string;
        field: string;
        special: string[] | null;
...
type SambaBOOperation<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_operations', {
    id: string;
    name: string | null;
    key: string;
    type: string;
    ...
    timestamp: string;
    options: Record<string, any> | null;
    resolve: SambaBOOperation<Schema> | string | null;
    reject: SambaBOOperation<Schema> | string | null;
    flow: SambaBOFlow<Schema> | string;
    date_created: 'datetime' | null;
    user_created: SambaBOUser<Schema> | string | null;
}>;

type SambaBOFlow<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_flows', {
    id: string;
    name: string;
    icon: string | null;
    color: string | null;
    ...
    accountability: string | null;
    options: Record<string, any> | null;
    operation: SambaBOOperation<Schema> | string | null;
    date_created: 'datetime' | null;
    user_created: SambaBOUser<Schema> | string | null;
}>;

type SambaBONotification<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_notifications', {
    id: string;
    timestamp: 'datetime' | null;
    status: string | null;
    recipient: SambaBOUser<Schema> | string;
    sender: SambaBOUser<Schema> | string | null;
    subject: string;
    message: string | null;
...
type SambaBOPanel<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_panels', {
    id: string;
    dashboard: SambaBODashboard<Schema> | string;
    name: string | null;
    icon: string | null;
    color: string | null;
    show_header: boolean;
...
type SambaBOPreset<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_presets', {
    id: number;
...
type SambaBORelation<Schema = any> = {
    collection: string;
    field: string;
    related_collection: string;
    meta: MergeCoreCollection<Schema, 'samba_bo_relations', {
        id: number;
...
type SambaBOSettings<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_settings', {
    id: 1;
    project_name: string;
    project_url: string;
    ...
    storage_default_folder: SambaBOFolder<Schema> | string | null;
...
type SambaBOShare<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_shares', {
    id: string;
    name: string | null;
    collection: string | null;
    item: string | null;
...
type SambaBOWebhook<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_webhooks', {
    id: number;
    name: string;
    method: string;
    url: string;
...
interface CoreSchema<Schema = any> {
    samba_bo_activity: SambaBOActivity<Schema>[];
    samba_bo_collections: SambaBOCollection<Schema>[];
    samba_bo_dashboards: SambaBODashboard<Schema>[];
    samba_bo_extensions: SambaBOExtension<Schema>[];
    samba_bo_fields: SambaBOField<Schema>[];
    samba_bo_files: SambaBOFile<Schema>[];
    samba_bo_flows: SambaBOFlow<Schema>[];
    samba_bo_folders: SambaBOFolder<Schema>[];
    samba_bo_notifications: SambaBONotification<Schema>[];
    samba_bo_operations: SambaBOOperation<Schema>[];
    samba_bo_panels: SambaBOPanel<Schema>[];
    samba_bo_permissions: SambaBOPermission<Schema>[];
    samba_bo_presets: SambaBOPreset<Schema>[];
    samba_bo_relations: SambaBORelation<Schema>[];
    samba_bo_roles: SambaBORole<Schema>[];
    samba_bo_settings: SambaBOSettings<Schema>;
    samba_bo_shares: SambaBOShare<Schema>[];
    samba_bo_users: SambaBOUser<Schema>[];
    samba_bo_versions: SambaBOVersion<Schema>[];
    samba_bo_webhooks: SambaBOWebhook<Schema>[];
}

type SambaBOTranslation<Schema = any> = MergeCoreCollection<Schema, 'samba_bo_translations', {
    id: string;
    language: string;
    key: string;
    value: string;
...
/**
 * Creates a client to communicate with a SambaBO REST WebSocket.
 *
 * @param config The optional configuration.
 *
 * @returns A SambaBO realtime client.
 */
declare function realtime(config?: WebSocketConfig): <Schema>(client: SambaBOClient<Schema>) => WebSocketClient<Schema>;
...
type CreateActivityOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOActivity<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createComment: <Schema, const TQuery extends Query<Schema, SambaBOActivity<Schema>>>(item: Partial<SambaBOActivity<Schema>>, query?: TQuery) => RestCommand<CreateActivityOutput<Schema, TQuery>, Schema>;

type CreateCollectionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOCollection<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createCollection: <Schema, const TQuery extends Query<Schema, SambaBOCollection<Schema>>>(item: NestedPartial<SambaBOCollection<Schema>>, query?: TQuery) => RestCommand<CreateCollectionOutput<Schema, TQuery>, Schema>;

type CreateDashboardOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBODashboard<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createDashboards: <Schema, const TQuery extends Query<Schema, SambaBODashboard<Schema>>>(items: Partial<SambaBODashboard<Schema>>[], query?: TQuery) => RestCommand<CreateDashboardOutput<Schema, TQuery>[], Schema>;
/**
 ...
 */
declare const createDashboard: <Schema, const TQuery extends Query<Schema, SambaBODashboard<Schema>>>(item: Partial<SambaBODashboard<Schema>>, query?: TQuery) => RestCommand<CreateDashboardOutput<Schema, TQuery>, Schema>;

type CreateFieldOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOField<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createField: <Schema, const TQuery extends Query<Schema, SambaBOField<Schema>>>(collection: keyof Schema, item: NestedPartial<SambaBOField<Schema>>, query?: TQuery) => RestCommand<CreateFieldOutput<Schema, TQuery>, Schema>;

type CreateFileOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFile<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const uploadFiles: <Schema, const TQuery extends Query<Schema, SambaBOFile<Schema>>>(data: FormData, query?: TQuery) => RestCommand<CreateFileOutput<Schema, TQuery>, Schema>;
/**
 ...
 */
declare const importFile: <Schema, TQuery extends Query<Schema, SambaBOFile<Schema>>>(url: string, data?: Partial<SambaBOFile<Schema>>, query?: TQuery) => RestCommand<CreateFileOutput<Schema, TQuery>, Schema>;

type CreateFlowOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFlow<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createFlows: <Schema, const TQuery extends Query<Schema, SambaBOFlow<Schema>>>(items: Partial<SambaBOFlow<Schema>>[], query?: TQuery) => RestCommand<CreateFlowOutput<Schema, TQuery>[], Schema>;
/**
 * Create a new flow.
 *
 ...
 * @returns Returns the flow object for the created flow.
 */
declare const createFlow: <Schema, TQuery extends Query<Schema, SambaBOFlow<Schema>>>(item: Partial<SambaBOFlow<Schema>>, query?: TQuery) => RestCommand<CreateFlowOutput<Schema, TQuery>, Schema>;

type CreateFolderOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFolder<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createFolders: <Schema, const TQuery extends Query<Schema, SambaBOFolder<Schema>>>(items: Partial<SambaBOFolder<Schema>>[], query?: TQuery) => RestCommand<CreateFolderOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the folder object of the folder that was created.
 */
declare const createFolder: <Schema, const TQuery extends Query<Schema, SambaBOFolder<Schema>>>(item: Partial<SambaBOFolder<Schema>>, query?: TQuery) => RestCommand<CreateFolderOutput<Schema, TQuery>, Schema>;
...
type CreateNotificationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBONotification<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createNotifications: <Schema, const TQuery extends Query<Schema, SambaBONotification<Schema>>>(items: Partial<SambaBONotification<Schema>>[], query?: TQuery) => RestCommand<CreateNotificationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the notification object for the created notification.
 */
declare const createNotification: <Schema, const TQuery extends Query<Schema, SambaBONotification<Schema>>>(item: Partial<SambaBONotification<Schema>>, query?: TQuery) => RestCommand<CreateNotificationOutput<Schema, TQuery>, Schema>;

type CreateOperationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOOperation<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createOperations: <Schema, const TQuery extends Query<Schema, SambaBOOperation<Schema>>>(items: Partial<SambaBOOperation<Schema>>[], query?: TQuery) => RestCommand<CreateOperationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the operation object for the created operation.
 */
declare const createOperation: <Schema, const TQuery extends Query<Schema, SambaBOOperation<Schema>>>(item: Partial<SambaBOOperation<Schema>>, query?: TQuery) => RestCommand<CreateOperationOutput<Schema, TQuery>, Schema>;

type CreatePanelOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPanel<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createPanels: <Schema, const TQuery extends Query<Schema, SambaBOPanel<Schema>>>(items: Partial<SambaBOPanel<Schema>>[], query?: TQuery) => RestCommand<CreatePanelOutput<Schema, TQuery>[], Schema>;
/**
 * Create a new panel.
 *
 ...
 * @returns Returns the panel object for the created panel.
 */
declare const createPanel: <Schema, const TQuery extends Query<Schema, SambaBOPanel<Schema>>>(item: Partial<SambaBOPanel<Schema>>, query?: TQuery) => RestCommand<CreatePanelOutput<Schema, TQuery>, Schema>;

type CreatePermissionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPermission<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createPermissions: <Schema, const TQuery extends Query<Schema, SambaBOPermission<Schema>>>(items: Partial<SambaBOPermission<Schema>>[], query?: TQuery) => RestCommand<CreatePermissionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 */
declare const createPermission: <Schema, const TQuery extends Query<Schema, SambaBOPermission<Schema>>>(item: Partial<SambaBOPermission<Schema>>, query?: TQuery) => RestCommand<CreatePermissionOutput<Schema, TQuery>, Schema>;

type CreatePolicyOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPolicy<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createPolicies: <Schema, const TQuery extends Query<Schema, SambaBOPolicy<Schema>>>(items: Partial<SambaBOPolicy<Schema>>[], query?: TQuery) => RestCommand<CreatePolicyOutput<Schema, TQuery>[], Schema>;
/**
 * Create a new policy
 *
 ...
 */
declare const createPolicy: <Schema, const TQuery extends Query<Schema, SambaBOPolicy<Schema>>>(item: Partial<SambaBOPolicy<Schema>>, query?: TQuery) => RestCommand<CreatePolicyOutput<Schema, TQuery>, Schema>;

type CreatePresetOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPreset<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createPresets: <Schema, const TQuery extends Query<Schema, SambaBOPreset<Schema>>>(items: Partial<SambaBOPreset<Schema>>[], query?: TQuery) => RestCommand<CreatePresetOutput<Schema, TQuery>[], Schema>;
/**
 * Create a new preset.
 *
 ...
 * @returns Returns the preset object for the created preset.
 */
declare const createPreset: <Schema, const TQuery extends Query<Schema, SambaBOPreset<Schema>>>(item: Partial<SambaBOPreset<Schema>>, query?: TQuery) => RestCommand<CreatePresetOutput<Schema, TQuery>, Schema>;

type CreateRelationOutput<Schema, Item extends object = SambaBORelation<Schema>> = ApplyQueryFields<Schema, Item, '*'>;
/**
 ...
 */
declare const createRelation: <Schema>(item: NestedPartial<SambaBORelation<Schema>>) => RestCommand<CreateRelationOutput<Schema>, Schema>;

type CreateRoleOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBORole<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createRoles: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(items: Partial<SambaBORole<Schema>>[], query?: TQuery) => RestCommand<CreateRoleOutput<Schema, TQuery>[], Schema>;
/**
 * Create a new role.
 *
 ...
 */
declare const createRole: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(item: Partial<SambaBORole<Schema>>, query?: TQuery) => RestCommand<CreateRoleOutput<Schema, TQuery>, Schema>;

type CreateShareOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOShare<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createShares: <Schema, const TQuery extends Query<Schema, SambaBOShare<Schema>>>(items: Partial<SambaBOShare<Schema>>[], query?: TQuery) => RestCommand<CreateShareOutput<Schema, TQuery>[], Schema>;
/**
 * Create a new share.
 *
 ...
 */
declare const createShare: <Schema, const TQuery extends Query<Schema, SambaBOShare<Schema>>>(item: Partial<SambaBOShare<Schema>>, query?: TQuery) => RestCommand<CreateShareOutput<Schema, TQuery>, Schema>;

type CreateTranslationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOTranslation<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createTranslations: <Schema, const TQuery extends Query<Schema, SambaBOTranslation<Schema>>>(items: Partial<SambaBOTranslation<Schema>>[], query?: TQuery) => RestCommand<CreateTranslationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the translation object for the created translation.
 */
declare const createTranslation: <Schema, const TQuery extends Query<Schema, SambaBOTranslation<Schema>>>(item: Partial<SambaBOTranslation<Schema>>, query?: TQuery) => RestCommand<CreateTranslationOutput<Schema, TQuery>, Schema>;

type CreateUserOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOUser<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createUsers: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(items: Partial<SambaBOUser<Schema>>[], query?: TQuery) => RestCommand<CreateUserOutput<Schema, TQuery>[], Schema>;
/**
 * Create a new user.
 *
 ...
 */
declare const createUser: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(item: Partial<SambaBOUser<Schema>>, query?: TQuery) => RestCommand<CreateUserOutput<Schema, TQuery>, Schema>;

type CreateContentVersionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOVersion<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createContentVersions: <Schema, const TQuery extends Query<Schema, SambaBOVersion<Schema>>>(items: Partial<SambaBOVersion<Schema>>[], query?: TQuery) => RestCommand<CreateContentVersionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 */
declare const createContentVersion: <Schema, const TQuery extends Query<Schema, SambaBOVersion<Schema>>>(item: Partial<SambaBOVersion<Schema>>, query?: TQuery) => RestCommand<CreateContentVersionOutput<Schema, TQuery>, Schema>;

type CreateWebhookOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOWebhook<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 */
declare const createWebhooks: <Schema, const TQuery extends Query<Schema, SambaBOWebhook<Schema>>>(items: Partial<SambaBOWebhook<Schema>>[], query?: TQuery) => RestCommand<CreateWebhookOutput<Schema, TQuery>[], Schema>;
/**
 ...
 */
declare const createWebhook: <Schema, const TQuery extends Query<Schema, SambaBOWebhook<Schema>>>(item: Partial<SambaBOWebhook<Schema>>, query?: TQuery) => RestCommand<CreateWebhookOutput<Schema, TQuery>, Schema>;
 ...
 * @returns Nothing
 */
declare const deleteComment: <Schema>(key: SambaBOActivity<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @returns
 */
declare const deleteCollection: <Schema>(collection: SambaBOCollection<Schema>['collection']) => RestCommand<void, Schema>;
 ...
 */
declare const deleteDashboards: <Schema>(keys: SambaBODashboard<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 */
declare const deleteDashboard: <Schema>(key: SambaBODashboard<Schema>['id']) => RestCommand<void, Schema>;
 ...
 */
declare const deleteField: <Schema>(collection: SambaBOField<Schema>['collection'], field: SambaBOField<Schema>['field']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteFiles: <Schema>(keys: SambaBOFile<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteFile: <Schema>(key: SambaBOFile<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteFlows: <Schema>(keys: SambaBOFlow<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteFlow: <Schema>(key: SambaBOFlow<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteFolders: <Schema>(keys: SambaBOFolder<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteFolder: <Schema>(key: SambaBOFolder<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteNotifications: <Schema>(keys: SambaBONotification<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteNotification: <Schema>(key: SambaBONotification<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteOperations: <Schema>(keys: SambaBOOperation<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteOperation: <Schema>(key: SambaBOOperation<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deletePanels: <Schema>(keys: SambaBOPanel<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deletePanel: <Schema>(key: SambaBOPanel<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deletePermissions: <Schema>(keys: SambaBOPermission<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deletePermission: <Schema>(key: SambaBOPermission<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deletePolicies: <Schema>(keys: SambaBOPolicy<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deletePolicy: <Schema>(key: SambaBOPolicy<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deletePresets: <Schema>(keys: SambaBOPreset<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deletePreset: <Schema>(key: SambaBOPreset<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if field is empty
 */
declare const deleteRelation: <Schema>(collection: SambaBORelation<Schema>['collection'], field: SambaBORelation<Schema>['field']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteRoles: <Schema>(keys: SambaBORole<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteRole: <Schema>(key: SambaBORole<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteShares: <Schema>(keys: SambaBOShare<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteShare: <Schema>(key: SambaBOShare<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteTranslations: <Schema>(keys: SambaBOTranslation<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteTranslation: <Schema>(key: SambaBOTranslation<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteUsers: <Schema>(keys: SambaBOUser<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteUser: <Schema>(key: SambaBOUser<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteContentVersions: <Schema>(keys: SambaBOVersion<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteContentVersion: <Schema>(key: SambaBOVersion<Schema>['id']) => RestCommand<void, Schema>;
 ...
 * @throws Will throw if keys is empty
 */
declare const deleteWebhooks: <Schema>(keys: SambaBOWebhook<Schema>['id'][]) => RestCommand<void, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const deleteWebhook: <Schema>(key: SambaBOWebhook<Schema>['id']) => RestCommand<void, Schema>;

type ReadActivityOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOActivity<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * Returns a list of activity actions.
 * @param query The query parameters
 * @returns An array of up to limit activity objects. If no items are available, data will be an empty array.
 */
declare const readActivities: <Schema, const TQuery extends Query<Schema, SambaBOActivity<Schema>>>(query?: TQuery) => RestCommand<ReadActivityOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readActivity: <Schema, const TQuery extends Query<Schema, SambaBOActivity<Schema>>>(key: SambaBOActivity<Schema>['id'], query?: TQuery) => RestCommand<ReadActivityOutput<Schema, TQuery>, Schema>;
 ...
 */
declare const readAssetRaw: <Schema>(key: SambaBOFile<Schema>['id'], query?: AssetsQuery) => RestCommand<ReadableStream<Uint8Array>, Schema>;
/**
 ...
 * @returns {Blob}
 */
declare const readAssetBlob: <Schema>(key: SambaBOFile<Schema>['id'], query?: AssetsQuery) => RestCommand<Blob, Schema>;
/**
 ...
 * @returns {ArrayBuffer}
 */
declare const readAssetArrayBuffer: <Schema>(key: SambaBOFile<Schema>['id'], query?: AssetsQuery) => RestCommand<ArrayBuffer, Schema>;

type ReadCollectionOutput<Schema, Item extends object = SambaBOCollection<Schema>> = ApplyQueryFields<Schema, Item, '*'>;
/**
 ...
 * @throws Will throw if collection is empty
 */
declare const readCollection: <Schema>(collection: SambaBOCollection<Schema>['collection']) => RestCommand<ReadCollectionOutput<Schema>, Schema>;

type ReadDashboardOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBODashboard<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all dashboards that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit dashboard objects. If no items are available, data will be an empty array.
 */
declare const readDashboards: <Schema, const TQuery extends Query<Schema, SambaBODashboard<Schema>>>(query?: TQuery) => RestCommand<ReadDashboardOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readDashboard: <Schema, const TQuery extends Query<Schema, SambaBODashboard<Schema>>>(key: SambaBODashboard<Schema>['id'], query?: TQuery) => RestCommand<ReadDashboardOutput<Schema, TQuery>, Schema>;

/**
 * List the available extensions in the project.
 * @returns An array of extensions.
 */
declare const readExtensions: <Schema>() => RestCommand<SambaBOExtension<Schema>[], Schema>;

type ReadFieldOutput<Schema, Item extends object = SambaBOField<Schema>> = ApplyQueryFields<Schema, Item, '*'>;
/**
 ...
 * @throws Will throw if collection is empty
 */
declare const readFieldsByCollection: <Schema>(collection: SambaBOField<Schema>['collection']) => RestCommand<ReadFieldOutput<Schema>[], Schema>;
/**
 *
 * @param key The primary key of the dashboard
 * @param query The query parameters
 ...
 * @throws Will throw if field is empty
 */
declare const readField: <Schema>(collection: SambaBOField<Schema>['collection'], field: SambaBOField<Schema>['field']) => RestCommand<ReadFieldOutput<Schema>, Schema>;

type ReadFileOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFile<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all files that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit file objects. If no items are available, data will be an empty array.
 */
declare const readFiles: <Schema, const TQuery extends Query<Schema, SambaBOFile<Schema>>>(query?: TQuery) => RestCommand<ReadFileOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readFile: <Schema, const TQuery extends Query<Schema, SambaBOFile<Schema>>>(key: SambaBOFile<Schema>['id'], query?: TQuery) => RestCommand<ReadFileOutput<Schema, TQuery>, Schema>;

type ReadFlowOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFlow<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all flows that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit flow objects. If no items are available, data will be an empty array.
 */
declare const readFlows: <Schema, const TQuery extends Query<Schema, SambaBOFlow<Schema>>>(query?: TQuery) => RestCommand<ReadFlowOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readFlow: <Schema, const TQuery extends Query<Schema, SambaBOFlow<Schema>>>(key: SambaBOFlow<Schema>['id'], query?: TQuery) => RestCommand<ReadFlowOutput<Schema, TQuery>, Schema>;

type ReadFolderOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFolder<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all folders that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit folder objects. If no items are available, data will be an empty array.
 */
declare const readFolders: <Schema, const TQuery extends Query<Schema, SambaBOFolder<Schema>>>(query?: TQuery) => RestCommand<ReadFolderOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readFolder: <Schema, const TQuery extends Query<Schema, SambaBOFolder<Schema>>>(key: SambaBOFolder<Schema>['id'], query?: TQuery) => RestCommand<ReadFolderOutput<Schema, TQuery>, Schema>;
...
/**
 * List all items that exist in SambaBO.
 *
 * @param collection The collection of the items
 * @param query The query parameters
 *
...
/**
 * Get an item that exists in SambaBO.
 *
 * @param collection The collection of the item
 * @param key The primary key of the item
 * @param query The query parameters
...
type ReadNotificationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBONotification<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all notifications that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit notification objects. If no items are available, data will be an empty array.
 */
declare const readNotifications: <Schema, const TQuery extends Query<Schema, SambaBONotification<Schema>>>(query?: TQuery) => RestCommand<ReadNotificationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readNotification: <Schema, const TQuery extends Query<Schema, SambaBONotification<Schema>>>(key: SambaBONotification<Schema>['id'], query?: TQuery) => RestCommand<ReadNotificationOutput<Schema, TQuery>, Schema>;

type ReadOperationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOOperation<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all operations that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit operation objects. If no items are available, data will be an empty array.
 */
declare const readOperations: <Schema, const TQuery extends Query<Schema, SambaBOOperation<Schema>>>(query?: TQuery) => RestCommand<ReadOperationOutput<Schema, TQuery>[], Schema>;
/**
 * List all Operations that exist in SambaBO.
 * @param key The primary key of the dashboard
 * @param query The query parameters
 ...
 * @throws Will throw if key is empty
 */
declare const readOperation: <Schema, const TQuery extends Query<Schema, SambaBOOperation<Schema>>>(key: SambaBOOperation<Schema>['id'], query?: TQuery) => RestCommand<ReadOperationOutput<Schema, TQuery>, Schema>;

type ReadPanelOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPanel<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Panels that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit panel objects. If no items are available, data will be an empty array.
 */
declare const readPanels: <Schema, const TQuery extends Query<Schema, SambaBOPanel<Schema>>>(query?: TQuery) => RestCommand<ReadPanelOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readPanel: <Schema, const TQuery extends Query<Schema, SambaBOPanel<Schema>>>(key: SambaBOPanel<Schema>['id'], query?: TQuery) => RestCommand<ReadPanelOutput<Schema, TQuery>, Schema>;

type ReadPermissionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPermission<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
...
/**
 * List all Permissions that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Permission objects. If no items are available, data will be an empty array.
 */
declare const readPermissions: <Schema, const TQuery extends Query<Schema, SambaBOPermission<Schema>>>(query?: TQuery) => RestCommand<ReadPermissionOutput<Schema, TQuery>[], Schema>;
/**
 * List all Permissions that exist in SambaBO.
 ...
 * @throws Will throw if key is empty
 */
declare const readPermission: <Schema, const TQuery extends Query<Schema, SambaBOPermission<Schema>>>(key: SambaBOPermission<Schema>['id'], query?: TQuery) => RestCommand<ReadPermissionOutput<Schema, TQuery>, Schema>;
/**
...
type ReadPolicyOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPolicy<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
 ...
 */
declare const readPolicies: <Schema, const TQuery extends Query<Schema, SambaBOPolicy<Schema>>>(query?: TQuery) => RestCommand<ReadPolicyOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readPolicy: <Schema, const TQuery extends Query<Schema, SambaBOPolicy<Schema>>>(key: SambaBOPolicy<Schema>['id'], query?: TQuery) => RestCommand<ReadPolicyOutput<Schema, TQuery>, Schema>;
/**
 * Check the current user's policy globals.
 */
declare const readPolicyGlobals: <Schema>() => RestCommand<ReadPolicyGlobalsOutput, Schema>;

type ReadPresetOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPreset<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Presets that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Preset objects. If no items are available, data will be an empty array.
 */
declare const readPresets: <Schema, const TQuery extends Query<Schema, SambaBOPreset<Schema>>>(query?: TQuery) => RestCommand<ReadPresetOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readPreset: <Schema, const TQuery extends Query<Schema, SambaBOPreset<Schema>>>(key: SambaBOPreset<Schema>['id'], query?: TQuery) => RestCommand<ReadPresetOutput<Schema, TQuery>, Schema>;

type ReadRelationOutput<Schema, Item extends object = SambaBORelation<Schema>> = ApplyQueryFields<Schema, Item, '*'>;
/**
 * List all Relations that exist in SambaBO.
 * @param query The query parameters
 ...
 * @throws Will throw if collection is empty
 */
declare const readRelationByCollection: <Schema>(collection: SambaBORelation<Schema>['collection']) => RestCommand<ReadRelationOutput<Schema>, Schema>;
/**
 * List an existing Relation by primary key.
 * @param collection The collection
 ...
 * @throws Will throw if field is empty
 */
declare const readRelation: <Schema, const TQuery extends Query<Schema, SambaBORelation<Schema>>>(collection: SambaBORelation<Schema>['collection'], field: SambaBORelation<Schema>['field']) => RestCommand<ReadRelationOutput<Schema, TQuery>, Schema>;

type ReadRevisionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBORevision<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Revisions that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Revision objects. If no items are available, data will be an empty array.
 */
declare const readRevisions: <Schema, const TQuery extends Query<Schema, SambaBORevision<Schema>>>(query?: TQuery) => RestCommand<ReadRevisionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readRevision: <Schema, const TQuery extends Query<Schema, SambaBORevision<Schema>>>(key: SambaBORevision<Schema>['id'], query?: TQuery) => RestCommand<ReadRevisionOutput<Schema, TQuery>, Schema>;

type ReadRoleOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBORole<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Roles that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Role objects. If no items are available, data will be an empty array.
 */
declare const readRoles: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(query?: TQuery) => RestCommand<ReadRoleOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readRole: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(key: SambaBORole<Schema>['id'], query?: TQuery) => RestCommand<ReadRoleOutput<Schema, TQuery>, Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readRolesMe: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(query?: TQuery) => RestCommand<ReadRoleOutput<Schema, TQuery>[], Schema>;

type ReadSettingOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOSettings<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * Retrieve Settings.
 *
 * @param query The query parameters
 ...
 */
declare const readSettings: <Schema, const TQuery extends Query<Schema, SambaBOSettings<Schema>>>(query?: TQuery) => RestCommand<ReadSettingOutput<Schema, TQuery>, Schema>;

type ReadShareOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOShare<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Shares that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Share objects. If no items are available, data will be an empty array.
 */
declare const readShares: <Schema, const TQuery extends Query<Schema, SambaBOShare<Schema>>>(query?: TQuery) => RestCommand<ReadShareOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readShare: <Schema, TQuery extends Query<Schema, SambaBOShare<Schema>>>(key: SambaBOShare<Schema>['id'], query?: TQuery) => RestCommand<ReadShareOutput<Schema, TQuery>, Schema>;
...
/**
 * List the singleton item in SambaBO.
 *
 * @param collection The collection of the items
 * @param query The query parameters
 *
...
type ReadTranslationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOTranslation<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Translations that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Translation objects. If no items are available, data will be an empty array.
 */
declare const readTranslations: <Schema, const TQuery extends Query<Schema, SambaBOTranslation<Schema>>>(query?: TQuery) => RestCommand<ReadTranslationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readTranslation: <Schema, const TQuery extends Query<Schema, SambaBOTranslation<Schema>>>(key: SambaBOTranslation<Schema>['id'], query?: TQuery) => RestCommand<ReadTranslationOutput<Schema, TQuery>, Schema>;

type ReadUserOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOUser<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all users that exist in SambaBO.
 *
 * @param query The query parameters
 *
 * @returns An array of up to limit user objects. If no items are available, data will be an empty array.
 */
declare const readUsers: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(query?: TQuery) => RestCommand<ReadUserOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readUser: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(key: SambaBOUser<Schema>['id'], query?: TQuery) => RestCommand<ReadUserOutput<Schema, TQuery>, Schema>;
/**
 ...
 */
declare const readMe: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(query?: TQuery) => RestCommand<ReadUserOutput<Schema, TQuery>, Schema>;

type ReadContentVersionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOVersion<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Content Versions that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Content Version objects. If no items are available, data will be an empty array.
 */
declare const readContentVersions: <Schema, const TQuery extends Query<Schema, SambaBOVersion<Schema>>>(query?: TQuery) => RestCommand<ReadContentVersionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readContentVersion: <Schema, const TQuery extends Query<Schema, SambaBOVersion<Schema>>>(key: SambaBOVersion<Schema>['id'], query?: TQuery) => RestCommand<ReadContentVersionOutput<Schema, TQuery>, Schema>;

type ReadWebhookOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOWebhook<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * List all Webhooks that exist in SambaBO.
 * @param query The query parameters
 * @returns An array of up to limit Webhook objects. If no items are available, data will be an empty array.
 */
declare const readWebhooks: <Schema, const TQuery extends Query<Schema, SambaBOWebhook<Schema>>>(query?: TQuery) => RestCommand<ReadWebhookOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const readWebhook: <Schema, const TQuery extends Query<Schema, SambaBOWebhook<Schema>>>(key: SambaBOWebhook<Schema>['id'], query?: TQuery) => RestCommand<ReadWebhookOutput<Schema, TQuery>, Schema>;
...
type UpdateActivityOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOActivity<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateComment: <Schema, const TQuery extends Query<Schema, SambaBOActivity<Schema>>>(key: SambaBOActivity<Schema>['id'], item: Partial<SambaBOActivity<Schema>>, query?: TQuery) => RestCommand<UpdateActivityOutput<Schema, TQuery>, Schema>;

type UpdateCollectionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOCollection<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if collection is empty
 */
declare const updateCollection: <Schema, const TQuery extends Query<Schema, SambaBOCollection<Schema>>>(collection: SambaBOCollection<Schema>['collection'], item: NestedPartial<SambaBOCollection<Schema>>, query?: TQuery) => RestCommand<UpdateCollectionOutput<Schema, TQuery>, Schema>;
/**
 ...
 */
declare const updateCollectionsBatch: <Schema, const TQuery extends Query<Schema, SambaBOCollection<Schema>>>(items: NestedPartial<SambaBOCollection<Schema>>[], query?: TQuery) => RestCommand<UpdateCollectionOutput<Schema, TQuery>, Schema>;

type UpdateDashboardOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBODashboard<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateDashboards: <Schema, const TQuery extends Query<Schema, SambaBODashboard<Schema>>>(keys: SambaBODashboard<Schema>['id'][], item: Partial<SambaBODashboard<Schema>>, query?: TQuery) => RestCommand<UpdateDashboardOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the dashboard objects for the updated dashboards.
 */
declare const updateDashboardsBatch: <Schema, const TQuery extends Query<Schema, SambaBODashboard<Schema>>>(items: NestedPartial<SambaBODashboard<Schema>>[], query?: TQuery) => RestCommand<UpdateDashboardOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateDashboard: <Schema, const TQuery extends Query<Schema, SambaBODashboard<Schema>>>(key: SambaBODashboard<Schema>['id'], item: Partial<SambaBODashboard<Schema>>, query?: TQuery) => RestCommand<UpdateDashboardOutput<Schema, TQuery>, Schema>;
 ...
 */
declare const updateExtension: <Schema>(bundle: string | null, name: string, data: NestedPartial<SambaBOExtension<Schema>>) => RestCommand<SambaBOExtension<Schema>, Schema>;

type UpdateFieldOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOField<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if field is empty
 */
declare const updateField: <Schema, const TQuery extends Query<Schema, SambaBOField<Schema>>>(collection: SambaBOField<Schema>['collection'], field: SambaBOField<Schema>['field'], item: NestedPartial<SambaBOField<Schema>>, query?: TQuery) => RestCommand<UpdateFieldOutput<Schema, TQuery>, Schema>;

type UpdateFileOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFile<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateFiles: <Schema, const TQuery extends Query<Schema, SambaBOFile<Schema>>>(keys: SambaBOFile<Schema>['id'][], item: Partial<SambaBOFile<Schema>>, query?: TQuery) => RestCommand<UpdateFileOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the file objects for the updated files.
 */
declare const updateFilesBatch: <Schema, const TQuery extends Query<Schema, SambaBOFile<Schema>>>(items: NestedPartial<SambaBOFile<Schema>>[], query?: TQuery) => RestCommand<UpdateFileOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateFile: <Schema, const TQuery extends Query<Schema, SambaBOFile<Schema>>>(key: SambaBOFile<Schema>['id'], item: Partial<SambaBOFile<Schema>> | FormData, query?: TQuery) => RestCommand<UpdateFileOutput<Schema, TQuery>, Schema>;

type UpdateFlowOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFlow<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateFlows: <Schema, const TQuery extends Query<Schema, SambaBOFlow<Schema>>>(keys: SambaBOFlow<Schema>['id'][], item: Partial<SambaBOFlow<Schema>>, query?: TQuery) => RestCommand<UpdateFlowOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the flow objects for the updated flows.
 */
declare const updateFlowsBatch: <Schema, const TQuery extends Query<Schema, SambaBOFlow<Schema>>>(items: NestedPartial<SambaBOFlow<Schema>>[], query?: TQuery) => RestCommand<UpdateFlowOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateFlow: <Schema, const TQuery extends Query<Schema, SambaBOFlow<Schema>>>(key: SambaBOFlow<Schema>['id'], item: Partial<SambaBOFlow<Schema>>, query?: TQuery) => RestCommand<UpdateFlowOutput<Schema, TQuery>, Schema>;

type UpdateFolderOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOFolder<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateFolders: <Schema, const TQuery extends Query<Schema, SambaBOFolder<Schema>>>(keys: SambaBOFolder<Schema>['id'][], item: Partial<SambaBOFolder<Schema>>, query?: TQuery) => RestCommand<UpdateFolderOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the folder objects of the folders that were updated.
 */
declare const updateFoldersBatch: <Schema, const TQuery extends Query<Schema, SambaBOFolder<Schema>>>(items: NestedPartial<SambaBOFolder<Schema>>[], query?: TQuery) => RestCommand<UpdateFolderOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateFolder: <Schema, const TQuery extends Query<Schema, SambaBOFolder<Schema>>>(key: SambaBOFolder<Schema>['id'], item: Partial<SambaBOFolder<Schema>>, query?: TQuery) => RestCommand<UpdateFolderOutput<Schema, TQuery>, Schema>;
...
type UpdateNotificationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBONotification<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateNotifications: <Schema, const TQuery extends Query<Schema, SambaBONotification<Schema>>>(keys: SambaBONotification<Schema>['id'][], item: Partial<SambaBONotification<Schema>>, query?: TQuery) => RestCommand<UpdateNotificationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the notification objects for the updated notifications.
 */
declare const updateNotificationsBatch: <Schema, const TQuery extends Query<Schema, SambaBONotification<Schema>>>(items: NestedPartial<SambaBONotification<Schema>>[], query?: TQuery) => RestCommand<UpdateNotificationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateNotification: <Schema, const TQuery extends Query<Schema, SambaBONotification<Schema>>>(key: SambaBONotification<Schema>['id'], item: Partial<SambaBONotification<Schema>>, query?: TQuery) => RestCommand<UpdateNotificationOutput<Schema, TQuery>, Schema>;

type UpdateOperationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOOperation<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateOperations: <Schema, const TQuery extends Query<Schema, SambaBOOperation<Schema>>>(keys: SambaBOOperation<Schema>['id'][], item: Partial<SambaBOOperation<Schema>>, query?: TQuery) => RestCommand<UpdateOperationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the operation objects for the updated operations.
 */
declare const updateOperationsBatch: <Schema, const TQuery extends Query<Schema, SambaBOOperation<Schema>>>(items: NestedPartial<SambaBOOperation<Schema>>[], query?: TQuery) => RestCommand<UpdateOperationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateOperation: <Schema, const TQuery extends Query<Schema, SambaBOOperation<Schema>>>(key: SambaBOOperation<Schema>['id'], item: Partial<SambaBOOperation<Schema>>, query?: TQuery) => RestCommand<UpdateOperationOutput<Schema, TQuery>, Schema>;

type UpdatePanelOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPanel<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updatePanels: <Schema, const TQuery extends Query<Schema, SambaBOPanel<Schema>>>(keys: SambaBOPanel<Schema>['id'][], item: Partial<SambaBOPanel<Schema>>, query?: TQuery) => RestCommand<UpdatePanelOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the panel objects for the updated panels.
 */
declare const updatePanelsBatch: <Schema, const TQuery extends Query<Schema, SambaBOPanel<Schema>>>(items: NestedPartial<SambaBOPanel<Schema>>[], query?: TQuery) => RestCommand<UpdatePanelOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updatePanel: <Schema, const TQuery extends Query<Schema, SambaBOPanel<Schema>>>(key: SambaBOPanel<Schema>['id'], item: Partial<SambaBOPanel<Schema>>, query?: TQuery) => RestCommand<UpdatePanelOutput<Schema, TQuery>, Schema>;

type UpdatePermissionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPermission<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updatePermissions: <Schema, const TQuery extends Query<Schema, SambaBOPermission<Schema>>>(keys: SambaBOPermission<Schema>['id'][], item: Partial<SambaBOPermission<Schema>>, query?: TQuery) => RestCommand<UpdatePermissionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the permission object for the updated permissions.
 */
declare const updatePermissionsBatch: <Schema, const TQuery extends Query<Schema, SambaBOPermission<Schema>>>(items: NestedPartial<SambaBOPermission<Schema>>[], query?: TQuery) => RestCommand<UpdatePermissionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updatePermission: <Schema, const TQuery extends Query<Schema, SambaBOPermission<Schema>>>(key: SambaBOPermission<Schema>['id'], item: Partial<SambaBOPermission<Schema>>, query?: TQuery) => RestCommand<UpdatePermissionOutput<Schema, TQuery>, Schema>;

type UpdatePolicyOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPolicy<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updatePolicies: <Schema, const TQuery extends Query<Schema, SambaBOPolicy<Schema>>>(keys: SambaBOPolicy<Schema>['id'][], item: Partial<SambaBOPolicy<Schema>>, query?: TQuery) => RestCommand<UpdatePolicyOutput<Schema, TQuery>[], Schema>;
/**
 ...
 */
declare const updatePoliciesBatch: <Schema, const TQuery extends Query<Schema, SambaBOPolicy<Schema>>>(items: NestedPartial<SambaBOPolicy<Schema>>[], query?: TQuery) => RestCommand<UpdatePolicyOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updatePolicy: <Schema, const TQuery extends Query<Schema, SambaBOPolicy<Schema>>>(key: SambaBOPolicy<Schema>['id'], item: Partial<SambaBOPolicy<Schema>>, query?: TQuery) => RestCommand<UpdatePolicyOutput<Schema, TQuery>, Schema>;

type UpdatePresetOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOPreset<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updatePresets: <Schema, const TQuery extends Query<Schema, SambaBOPreset<Schema>>>(keys: SambaBOPreset<Schema>['id'][], item: Partial<SambaBOPreset<Schema>>, query?: TQuery) => RestCommand<UpdatePresetOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the preset objects for the updated presets.
 */
declare const updatePresetsBatch: <Schema, const TQuery extends Query<Schema, SambaBOPreset<Schema>>>(items: NestedPartial<SambaBOPreset<Schema>>[], query?: TQuery) => RestCommand<UpdatePresetOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updatePreset: <Schema, const TQuery extends Query<Schema, SambaBOPreset<Schema>>>(key: SambaBOPreset<Schema>['id'], item: Partial<SambaBOPreset<Schema>>, query?: TQuery) => RestCommand<UpdatePresetOutput<Schema, TQuery>, Schema>;

type UpdateRelationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBORelation<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @returns Returns the relation object for the created relation.
 */
declare const updateRelation: <Schema, const TQuery extends Query<Schema, SambaBORelation<Schema>>>(collection: SambaBORelation<Schema>['collection'], field: SambaBORelation<Schema>['field'], item: NestedPartial<SambaBORelation<Schema>>, query?: TQuery) => RestCommand<UpdateRelationOutput<Schema, TQuery>, Schema>;

type UpdateRoleOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBORole<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateRoles: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(keys: SambaBORole<Schema>['id'][], item: Partial<SambaBORole<Schema>>, query?: TQuery) => RestCommand<UpdateRoleOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the role objects for the updated roles.
 */
declare const updateRolesBatch: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(items: Partial<SambaBORole<Schema>>[], query?: TQuery) => RestCommand<UpdateRoleOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateRole: <Schema, const TQuery extends Query<Schema, SambaBORole<Schema>>>(key: SambaBORole<Schema>['id'], item: Partial<SambaBORole<Schema>>, query?: TQuery) => RestCommand<UpdateRoleOutput<Schema, TQuery>, Schema>;

type UpdateSettingOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOSettings<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 * Update Settings
 * @param item
 * @param query
 * @returns Returns the settings object.
 */
declare const updateSettings: <Schema, const TQuery extends Query<Schema, SambaBOSettings<Schema>>>(item: Partial<SambaBOSettings<Schema>>, query?: TQuery) => RestCommand<UpdateSettingOutput<Schema, TQuery>[], Schema>;

type UpdateShareOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOShare<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateShares: <Schema, const TQuery extends Query<Schema, SambaBOShare<Schema>>>(keys: SambaBOShare<Schema>['id'][], item: Partial<SambaBOShare<Schema>>, query?: TQuery) => RestCommand<UpdateShareOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the share objects for the updated shares.
 */
declare const updateSharesBatch: <Schema, const TQuery extends Query<Schema, SambaBOShare<Schema>>>(items: NestedPartial<SambaBOShare<Schema>>[], query?: TQuery) => RestCommand<UpdateShareOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateShare: <Schema, const TQuery extends Query<Schema, SambaBOShare<Schema>>>(key: SambaBOShare<Schema>['id'], item: Partial<SambaBOShare<Schema>>, query?: TQuery) => RestCommand<UpdateShareOutput<Schema, TQuery>, Schema>;
...
type UpdateTranslationOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOTranslation<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateTranslations: <Schema, const TQuery extends Query<Schema, SambaBOTranslation<Schema>>>(keys: SambaBOTranslation<Schema>['id'][], item: Partial<SambaBOTranslation<Schema>>, query?: TQuery) => RestCommand<UpdateTranslationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the translation objects for the updated translations.
 */
declare const updateTranslationsBatch: <Schema, const TQuery extends Query<Schema, SambaBOTranslation<Schema>>>(items: Partial<SambaBOTranslation<Schema>>[], query?: TQuery) => RestCommand<UpdateTranslationOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateTranslation: <Schema, const TQuery extends Query<Schema, SambaBOTranslation<Schema>>>(key: SambaBOTranslation<Schema>['id'], item: Partial<SambaBOTranslation<Schema>>, query?: TQuery) => RestCommand<UpdateTranslationOutput<Schema, TQuery>, Schema>;

type UpdateUserOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOUser<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateUsers: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(keys: SambaBOUser<Schema>['id'][], item: Partial<SambaBOUser<Schema>>, query?: TQuery) => RestCommand<UpdateUserOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the user objects for the updated users.
 */
declare const updateUsersBatch: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(items: NestedPartial<SambaBOUser<Schema>>[], query?: TQuery) => RestCommand<UpdateUserOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateUser: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(key: SambaBOUser<Schema>['id'], item: Partial<SambaBOUser<Schema>>, query?: TQuery) => RestCommand<UpdateUserOutput<Schema, TQuery>, Schema>;
/**
 ...
 */
declare const updateMe: <Schema, const TQuery extends Query<Schema, SambaBOUser<Schema>>>(item: Partial<SambaBOUser<Schema>>, query?: TQuery) => RestCommand<UpdateUserOutput<Schema, TQuery>, Schema>;

type UpdateContentVersionOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOVersion<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateContentVersions: <Schema, const TQuery extends Query<Schema, SambaBOVersion<Schema>>>(keys: SambaBOVersion<Schema>['id'][], item: Partial<SambaBOVersion<Schema>>, query?: TQuery) => RestCommand<UpdateContentVersionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @returns Returns the Content Version objects for the updated Content Versions.
 */
declare const updateContentVersionsBatch: <Schema, const TQuery extends Query<Schema, SambaBOVersion<Schema>>>(items: NestedPartial<SambaBOVersion<Schema>>[], query?: TQuery) => RestCommand<UpdateContentVersionOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateContentVersion: <Schema, const TQuery extends Query<Schema, SambaBOVersion<Schema>>>(key: SambaBOVersion<Schema>['id'], item: Partial<SambaBOVersion<Schema>>, query?: TQuery) => RestCommand<UpdateContentVersionOutput<Schema, TQuery>, Schema>;

type UpdateWebhookOutput<Schema, TQuery extends Query<Schema, Item>, Item extends object = SambaBOWebhook<Schema>> = ApplyQueryFields<Schema, Item, TQuery['fields']>;
/**
 ...
 * @throws Will throw if keys is empty
 */
declare const updateWebhooks: <Schema, const TQuery extends Query<Schema, SambaBOWebhook<Schema>>>(keys: SambaBOWebhook<Schema>['id'][], item: Partial<SambaBOWebhook<Schema>>, query?: TQuery) => RestCommand<UpdateWebhookOutput<Schema, TQuery>[], Schema>;
/**
 ...
 * @throws Will throw if key is empty
 */
declare const updateWebhook: <Schema, const TQuery extends Query<Schema, SambaBOWebhook<Schema>>>(key: SambaBOWebhook<Schema>['id'], item: Partial<SambaBOWebhook<Schema>>, query?: TQuery) => RestCommand<UpdateWebhookOutput<Schema, TQuery>, Schema>;

/**
 * Resets both the data and schema cache of SambaBO. This endpoint is only available to admin users.
 * @returns Nothing
 */
 ...
 * @returns Nothing
 */
declare const utilsExport: <Schema, TQuery extends Query<Schema, Schema[Collection]>, Collection extends keyof Schema>(collection: Collection, format: FileFormat, query: TQuery, file: Partial<SambaBOFile<Schema>>) => RestCommand<void, Schema>;
 ...
 */
declare const saveToContentVersion: <Schema, Collection extends keyof Schema, Item = UnpackList<Schema[Collection]>>(id: SambaBOVersion<Schema>['id'], item: Partial<Item>) => RestCommand<Item, Schema>;
/**
...
Content Version)
 */
declare const compareContentVersion: <Schema, Collection extends keyof Schema, Item = UnpackList<Schema[Collection]>>(id: SambaBOVersion<Schema>['id']) => RestCommand<{
    outdated: boolean;
    mainHash: string;
 ...
 */
declare const promoteContentVersion: <Schema, Collection extends keyof Schema, Item = UnpackList<Schema[Collection]>>(id: SambaBOVersion<Schema>['id'], mainHash: string, fields?: (keyof UnpackList<Item>)[]) => RestCommand<string | number, Schema>;
...
/**
 * Creates a client to communicate with the SambaBO REST API.
 *
 * @returns A SambaBO REST client.
 */
declare const rest: (config?: Partial<RestConfig>) => <Schema>(client: SambaBOClient<Schema>) => RestClient<Schema>;
 ...
 * @param value
 * @param message
 * @throws Throws an error if the collection starts with the `samba_bo_` prefix
 */
